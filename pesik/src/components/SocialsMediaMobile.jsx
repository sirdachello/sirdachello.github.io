...
export default function SocialsMediaMobile() {
    ...
    return (
        <ul className="flex flex-col absolute top-28 right-5 gap-4 sm:right-12 md:hidden">
            <li className="list-none"><a href="#instagram"><img className="size-8" src={imageInst} alt="" /></a></li>
            <li className="list-none"><a href="#instagram"><img className="size-8" src={imageFacebook} alt="" /></a></li>
        </ul>
    )
}