...
!function (e) {
  ...
  var i = n(6),
    ...
    for (p in l) {
      u = !g && m && void 0 !== m[p], f = (u ? m : l)[p], d = w && u ? s(f, i) : b && "function" == typeof f ? s(Function.call, f) : f, m && a(m, p, f, t & e.U), y[p] != f && r(y, p, d), b && x[p] != f && (x[p] = f);
    }
  };
  ...
  e.exports = function (e, t) {
    ...
    return function (t, s, g) {
      for (var h, v, b = r(t), w = o(b), m = i(s, g, 3), y = a(w.length), x = 0, C = n ? d(t, y) : c ? d(t, 0) : void 0; y > x; x++) {
        if ((f || x in w) && (h = w[x], v = m(h, x, b), e)) if (n) C[x] = v;else if (v) switch (e) {
          case 3:
            return !0;
  ...
  !function (t, n) {
    ...
    return r || n.addEventListener(o, _e = function e() {
      for (n.removeEventListener(o, _e), r = 1; _e = t.shift();) {
        _e();
      }
    }), function (e) {
  ...
  */
  ...
  function l(e, t) {
    ...
    } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = c(t), i = f.bind(null, n), o = function o() {
      a(n), n.href && URL.revokeObjectURL(n.href);
    }) : (n = s(t), i = u.bind(null, n), o = function o() {
      a(n);
    });
